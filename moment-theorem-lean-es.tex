...
segunda~\cite{PartIII}, y este art\'iculo lleva el resto. El cierre, al final, no usa la recursi\'on de
Newton (Secci\'on~\ref{sec:boundary}): la primera cuenta---la de Girard---es la \'unica que la
demostraci\'on puede ahorrarse.
...
reales que se comportan como autovalores de una matriz que no existe. El teorema del momento de Godsil
...
caracter\'istico de ninguna matriz, as\'i que ninguna de las herramientas matriciales se le aplica
...
El autor fij\'o los objetivos y valid\'o la matem\'atica; el asistente (Claude, Anthropic) redact\'o
...
pertenece a ninguna matriz---cuyos momentos se acotan. Es precisamente la identidad invocada, casi siempre t\'acitamente, all\'i
...
Y una para guardar. \emph{El polinomio de emparejamientos no es el polinomio caracter\'istico de
ninguna matriz y, sin embargo, las sumas de potencias de sus ra\'ices cuentan caminos exactamente como
lo har\'ian las de una matriz; el teorema dice d\'onde viven esos momentos---pero el espectro que
