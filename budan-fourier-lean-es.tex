...
unificador profundo, el \emph{\'indice de Cauchy}, est\'a axiomatizado mediante \emph{cadenas de Sturm}
abstractas por Eisermann~\cite{eisermann} y \emph{ya} se ha verificado por m\'aquina, en Isabelle/HOL,
por Li y Paulson~\cite{liCauchy}. Lo que falta es una formalizaci\'on en \emph{Lean} de ese marco. Una
sub-pregunta, eso s\'i, queda genuinamente abierta y es propia de este trabajo: los \emph{bloques que se
anulan} de la torre rompen la coprimalidad en que se apoyan los axiomas cl\'asicos de cadena de
Sturm---¿los satisfacen igual, o fuerzan un conjunto estrictamente m\'as d\'ebil en el que el
colapso/alternancia de la Secci\'on~\ref{sec:q2} sea la ley local general (de modo que
\lean{Rseq}/\lean{Lseq} sean lo primitivo y \lean{FlankReduce} un caso degenerado)? El objetivo honesto
es llevar una unificaci\'on conocida a Mathlib, y hallar los axiomas m\'as d\'ebiles que la torre
fuerza.
