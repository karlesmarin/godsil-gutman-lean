...
Abel's five-term relation, a two-variable identity we did \emph{not} formalize
here.\footnote{It is formalized in a companion paper~\cite{fiveterm}, on the dilogarithm
built here; the detour of this section---reaching the golden values without Abel---remains
the honest record of how they were first obtained in this development.}
Are we stuck?
...
two-variable dilogarithm identity follows. \emph{Now formalized} in a companion
paper~\cite{fiveterm}, on the dilogarithm built here; the reflection/Landen machinery of
this paper was the warm-up.
...
\bibitem{fiveterm} C.~Mar\'in, \emph{The Pentagon, Machine-Checked: Abel's five-term
relation for the dilogarithm in Lean~4}, companion paper, same repository, 2026.
\end{thebibliography}
