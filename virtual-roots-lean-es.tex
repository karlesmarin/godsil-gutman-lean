...
\medskip
{\sloppy\noindent El desarrollo son dos ficheros Lean. \lean{VirtualRoots.lean} lleva la teor\'ia
estructural; \lean{VirtualRootsCount.lean}, el recuento exacto construido encima. Los lemas que soportan
el peso est\'an reunidos en la Secci\'on~\ref{sec:blocks}, y los l\'imites que quedan---la continuidad, y
el objeto global en todo $\R$---en la Secci\'on~\ref{sec:boundary}. Si solo lees dos cosas, lee el
entrelazado (Teorema~\ref{thm:interlace}) y el recuento (Teorema~\ref{thm:count}).\par}
