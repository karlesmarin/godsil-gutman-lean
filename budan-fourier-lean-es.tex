...
\item \emph{Un teorema tras dos recuentos.} El recuento de coeficientes de Descartes y el recuento de la
torre son, tras desplegar, la misma clase de objeto (Secci\'on~\ref{sec:q4}), y el recuento de la cadena
de Sturm est\'a construido sobre el mismo instrumental (\cite{sturmlean}). ¿Hay un \'unico enunciado en
Lean---un principio de variaci\'on de signo sobre una ``sucesi\'on admisible'' abstracta---del que la
cota de Descartes, la cota en intervalo de Budan--Fourier y el recuento exacto de Sturm sean tres
instancias, de modo que la biblioteca guarde el lema local una vez en lugar de tres?
