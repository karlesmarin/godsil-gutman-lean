...
\item[\textbf{On the crossing.}] The title theorem exists because two formalized
threads met in an object neither owned. Today's proof libraries contain thousands of
disconnected theorems. How many other pairs are one substitution away from a
Theorem~\ref{thm:clock} --- and could a proof assistant be made to \emph{search} for
such crossings, instead of waiting for them?
\end{enumerate}
