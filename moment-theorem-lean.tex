...
graph: as a combinatorial object whose walks one counts, and as the carrier of a spectrum---belonging
to no matrix---whose moments one bounds. It is precisely the identity invoked, usually tacitly, wherever one of these is
...
And one to keep. \emph{The matching polynomial is the characteristic polynomial of no matrix, yet its
root power sums count walks exactly as a matrix's would; the theorem says where those moments live---but
